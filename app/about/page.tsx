  ...
  return (
    <div className="flex min-h-screen flex-col bg-neutral-950 text-neutral-50">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10">
        <h1 className="text-4xl font-semibold tracking-tight">About DVD Screensaver</h1>
        ...
        <article className="mt-10 space-y-8 text-neutral-300">
          <section>
            <h2 className="text-2xl font-semibold text-neutral-50">What It Is</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-neutral-50">Features</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-neutral-50">Why It Was Built</h2>
            <div className="mt-3 space-y-3">
              <p>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <Link
                href="/contact/"
                className="underline underline-offset-2 text-neutral-200 hover:text-white transition"
              >
