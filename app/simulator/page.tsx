  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-slate-900 dark:bg-neutral-950 dark:text-neutral-50">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10">
        <h1 className="text-4xl font-semibold tracking-tight text-slate-900 dark:text-neutral-50">DVD Screensaver Simulator</h1>
        ...
        <section className="mt-10 rounded-xl border border-orange-400 bg-orange-50 dark:border-orange-500/40 dark:bg-orange-500/10 p-6 text-center">
          <p className="text-lg font-semibold text-slate-900 dark:text-neutral-50">Try the DVD Screensaver Simulator</p>
        ...
        <article className="mt-10 space-y-8 text-slate-700 dark:text-neutral-300">
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-neutral-50">How the Simulation Works</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-neutral-50">What You Can Customise</h2>
            <ul className="mt-3 space-y-2 list-disc pl-5 text-slate-700 dark:text-neutral-300">
              <li><strong className="text-slate-800 dark:text-neutral-200">Logo style</strong> — 3 DVD logo variants: Classic DVD Logo, DVD Video Logo, and DVD Video Logo (Alt)</li>
              <li><strong className="text-slate-800 dark:text-neutral-200">Speed</strong> — slow drift to fast bounce, adjustable at any time</li>
              <li><strong className="text-slate-800 dark:text-neutral-200">Size</strong> — small to large, adjustable during animation</li>
              <li><strong className="text-slate-800 dark:text-neutral-200">Colour</strong> — rotating (changes on bounce), solid presets, custom picker, or continuous hue cycle</li>
              <li><strong className="text-slate-800 dark:text-neutral-200">Fullscreen</strong> — press F or Space, or click the canvas</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-neutral-50">Why Use a DVD Screensaver Simulator?</h2>
            <div className="mt-3 space-y-3">
              <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-neutral-50">Simulator vs. the Original</h2>
            <div className="mt-3 overflow-x-auto text-slate-700 dark:text-neutral-300">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-slate-300 dark:border-neutral-700">
                    <th className="py-2 pr-4 text-left text-slate-500 dark:text-neutral-400 font-medium">Feature</th>
                    <th className="py-2 pr-4 text-left text-slate-500 dark:text-neutral-400 font-medium">Original DVD Player</th>
                    <th className="py-2 text-left text-slate-500 dark:text-neutral-400 font-medium">This Simulator</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 dark:divide-neutral-800">
                  {[
                    ...
                    <tr key={feat}>
                      <td className="py-2 pr-4 text-slate-700 dark:text-neutral-300">{feat}</td>
                      <td className="py-2 pr-4 text-slate-500 dark:text-neutral-400">{orig}</td>
